...
while opcao !=5 :
    ...
    [2] Corredor''')
            ...
            if fileira == 1 :
                poltrona = int(input("\n\033[32mPossuimos apenas 24 poltronas em nossos veículos!\033[m"+"Qual o número da poltrona deseja?"))
                poltrona = (poltrona - 1)
                ...
                poltrona = (poltrona - 1)
                if poltrona >=26:
                    print("\033[31mPoltrona não existe!\033[m")
